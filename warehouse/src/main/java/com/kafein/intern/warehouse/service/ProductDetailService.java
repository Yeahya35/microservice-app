...
public class ProductDetailService {
    ...
    public ProductDetailService(ProductDetailMapper productDetailMapper, ProductDetailRepository productDetailRepository,
                                ...
                                ProcessDetailMapper processDetailMapper, NotificationProducerService notificationProducerService) {
    ...
    public boolean removeProductToWarehouse(ProductDetail detail, int count, int warehouseId) {
        ...
        if (detail.getProductCount()- count < detail.getProductLimit()) {
            ...
            String body = "critical level for " +  detail.getProduct().getName() + " at warehouse " + detail.getWarehouse().getWarehouseName();
            SimpleEmailDTO emailDTO = SimpleEmailDTO.builder()
                    .sendTo("yahyaeren35@hotmail.com")
                    .subject("CRITICAL LEVEL")
                    .body(body).build();
            notificationProducerService.sendToQueue(emailDTO);
